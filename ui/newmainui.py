...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.gridLayout.addWidget(self.imageInput, 1, 0, 1, 3)
        ...
        self.gridLayout.addWidget(self.outInput, 7, 0, 1, 3)
        ...
        self.gridLayout.addWidget(self.labelInput, 4, 0, 1, 3)
        ...
        self.gridLayout.addWidget(self.horizontalSlider, 9, 2, 1, 1)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_5.setText(QCoreApplication.translate("Dialog", u"Random %:", None))
